class Bio7Content extends InteractiveItem {
    private Point position;
    private Bio7CollectorUseCase useCase;
    ...
    public Bio7Content(
        ...
        useCase = new Bio7CollectorUseCase(parent, device);
    }
    ...
    public void onEvent(Event kind) {
        if (kind == Event.newFrame) {
            if (useCase == null) {
                ...
                bigBonusCounter.setValue(useCase.getHazardRushCount());
                regBonusCounter.setValue(useCase.getClimaxBattleCount());
